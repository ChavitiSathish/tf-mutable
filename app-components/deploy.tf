resource "null_resource" "apply" {
  ...
  provisioner "remote-exec" {
    ...
    inline = [
      "ansible-pull -i localhost, -U https://github.com/ChavitiSathish/ansible.git roboshop-pull.yml -e COMPONENT=${var.COMPONENT} -e ENV=${var.ENV} -e APP_PORT=80 -e APP_VERSION=${var.APP_VERSION}"
    ]
